...
?>
            ...
            <div id="bloc_commentaire">
                <div class="vote">
                    ...
                    <!-- Bouton Like -->
                    <div class="vote_boutons">
                        <button class="vote_bouton" name="vote" value="like" onclick= "window.location.href='iconlike.php?t=1&id=<?= $id; ?>';">
                    ...
                    <!-- Bouton Dislike -->
                    <div class="vote_boutons">
                        <button class="vote_bouton"  name="vote" value="dislike" onclick= "window.location.href='iconlike.php?t=2&id=<?= $id; ?>';">
